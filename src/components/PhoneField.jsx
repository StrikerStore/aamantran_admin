 ...
 *
 * Not the panel's own ui/Select either: that component flattens its children
 * and ignores <optgroup>, which would leave 210 countries in one ungrouped list.
 * Native brings keyboard type-ahead and the popular-first grouping for free. It
 * inherits .form-input so it still reads as part of the form.
 *
