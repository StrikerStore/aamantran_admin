 ...
 */
export function Select({ value, onChange, children, className = '', style, disabled, required, id }) {
  ...
  // form-* classes are 100%-width controls; filter-select keeps natural width
  const fullWidth = /form-(select|input)/.test(className);
