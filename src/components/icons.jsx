/**
 * The panel's icons, in one place.
 *
 * They used to live at the bottom of Layout.jsx, which meant the navigation
 * manifest could not name one without importing the layout that the manifest
 * itself feeds. Nothing about them changed in the move.
 */
